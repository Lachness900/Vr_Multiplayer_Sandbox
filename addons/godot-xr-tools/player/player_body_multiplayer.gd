...
func is_xr_class(name : String) -> bool:
	return name == "XRToolsPlayerBodyMultiplayer"
...
func _ready():
	...
	_movement_providers = get_tree().get_nodes_in_group("multi_movement_providers")
...
static func find_instance(node: Node) -> XRToolsPlayerBodyMultiplayer:
	return XRTools.find_xr_child(
		XRHelpers.get_xr_origin(node),
		"*",
		"XRToolsPlayerBody") as XRToolsPlayerBodyMultiplayer
