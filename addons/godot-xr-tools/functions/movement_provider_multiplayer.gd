...
class_name XRToolsMovementProviderMultiplayer
extends Node
...
## Player body scene
const PLAYER_BODY := preload("res://addons/godot-xr-tools/player/player_body_multiplayer.tscn")
...
func _create_player_body_node():
	...
	var player_body := XRToolsPlayerBodyMultiplayer.find_instance(self)
	if !player_body:
...
func is_xr_class(name : String) -> bool:
	return name == "XRToolsMovementProviderMultiplayer"
...
func physics_pre_movement(_delta: float, _player_body: XRToolsPlayerBodyMultiplayer):
	pass


## Override this method to apply motion to the PlayerBody
func physics_movement(_delta: float, _player_body: XRToolsPlayerBodyMultiplayer, _disabled: bool):
	pass
