@tool
class_name XRToolsMovementMultiplayerTurn
...
func is_xr_class(name : String) -> bool:
	return name == "XRToolsMovementMultiplayerTurn" or super(name)


# Perform jump movement
func physics_movement(delta: float, player_body: XRToolsPlayerBodyMultiplayer, _disabled: bool):
	# Skip is not authority
